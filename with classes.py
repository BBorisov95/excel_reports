...
ot3_difference_in_percent = ((ot3.ReportNew.new_period_turnover() / ot3.ReportOld.old_period_turnover() - 1) * 100)
ot3_difference_in_bgn = (ot3.ReportNew.new_period_turnover() - ot3.ReportOld.old_period_turnover())
percent_from_company = ((ot3.ReportNew.new_period_turnover() / Report.self.company_new_period_value) * 100)
sold_value_new = (ot3.ReportNew.new_period_turnover() / ot3.ReportNew.new_period_sold_pcs())
sold_value_old = (ot3.ReportOld.old_period_turnover() / ot3.ReportOld.old_period_sold_pcs)
